...
public class Constrain : Module
{
    ...
    public void Forward(CudaDeviceVariable<Half> logits, int size, CudaDeviceVariable<int> constraint) =>
        base.Forward(logits.DevicePointer, size, constraint.DevicePointer, constraint.Size);
}
